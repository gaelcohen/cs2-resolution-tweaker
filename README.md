...
App diminuta de bandeja del sistema (Windows) para alternar con un clic entre un perfil **CS2** (resolución estirada + Digital Vibrance alto) y tu perfil **Normal**, cambiando la **resolución** y el **Digital Vibrance** de NVIDIA. Los cambios se aplican **solo al monitor que elijas**.

A tiny Windows tray app to switch — in one click — between a **CS2** profile (stretched resolution + high Digital Vibrance) and your **Normal** profile, changing **resolution** and NVIDIA **Digital Vibrance**. Changes apply **only to the monitor you pick**.
...
- **Digital Vibrance**: a 0–100 slider. On NVIDIA's scale, **50 = neutral** and **100 = maximum**.
